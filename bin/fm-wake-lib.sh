...
# and for crewmate slots (bin/fm-spawn.sh, holder fm-<id>). The holder is only a
# label, though: it does not name the home, and slots acquired before crewmate
# spawns leased durably went through the interactive pane-driven `treehouse
# get`, whose state entry is a live process lease (owner_pid plus
