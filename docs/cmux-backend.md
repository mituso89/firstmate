...
The spawn's worktree-arrival wait and relaunch placement check send begin and end markers around `pwd`, capture the marked block, and join wrapped path lines.
